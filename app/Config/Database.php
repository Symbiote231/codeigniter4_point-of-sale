...
class Database extends Config
{
    ...
    public array $default = [
        ...
        'username'     => 'point_of_sale_user', // MySQL user for your app.
        'password'     => 'PointOfSale', // Secure password for the user.
        'database'     => 'point_of_sale', // Name of the database your app will use.
    ...
    public function __construct()
    {
        ...
        $this->default = [
            ...
            'username'     => $_ENV['DB_USERNAME'] ?? 'point_of_sale_user', // MySQL user for your app.
            'password'     => $_ENV['DB_PASSWORD'] ?? 'PointOfSale', // Secure password for the user.
            'database'     => $_ENV['DB_DATABASE'] ?? 'point_of_sale', // Name of the database your app will use.
            'DBDriver'     => 'MySQLi', // PHP's MySQL driver; faster than PDO for MySQL.
            'DBPrefix'     => '', // Prefix for table names, optional.
            'pConnect'     => false, // Persistent connection; false is usually better.
            'DBDebug'      => true, // Enables error reporting for queries during development.
